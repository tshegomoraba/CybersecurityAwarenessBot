...
namespace CyberSecurityAwarenessBotGUI
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            // Wire up events from ChatbotService
...
'Quiz me on cybersecurity'",
        ...
        {
            var taskForm = new TaskForm(_chatbotService.TaskService, _chatbotService.LogService);
            taskForm.ShowDialog(this);
        }

        private void OpenQuiz()
        {
            var quizForm = new QuizForm(_quizService, _chatbotService.LogService);
